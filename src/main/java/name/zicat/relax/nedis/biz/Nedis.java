...
public class Nedis {
	...
	/**
	 * add key and field-value to dbIndex (type=Map)
	 * @param dbIndex
	 * @param batchDatas
	 * @return
	 */
	 ...
	 * @return
	 */
	public boolean addHashMap2Nedis(final Integer dbIndex, final String key, final Map<String, String> value, final boolean isRemoveOld) {
	...
	/**
	 * add key and map to dbIndex (type=Map)
	 * @param dbIndex
	 * @param batchDatas
	 * @param seconds
	 * @return
	 */
	public boolean addHashMap2Nedis(final Integer dbIndex, final String key, final Map<String, String> value, final boolean isRemoveOld, final int seconds) {
